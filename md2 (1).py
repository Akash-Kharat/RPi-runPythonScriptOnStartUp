...
client = ModbusClient(method='rtu', port='/dev/ttyAMA0',  parity='N', baudrate=9600, bytesize=8, stopbits=1, timeout=2, strict=False)
...
mqtt_topics = ["transmonk.mechmark/command", "transmonk/mechmark/reconfigure"]
...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        if msg.topic == "transmonk.mechmark/command":
        ...
        elif msg.topic == "transmonk/mechmark/reconfigure":
...
client_mqtt.connect("192.168.0.61", 1883, 60)  # Replace with your MQTT broker information
        ...
        for slave_id in slave_ids:
            ...
            try:
                ...
                if response.isError():
                    ...
                    client_mqtt.publish("transmonk/mechmark/data", json.dumps({"masterid":1, "deviceid": slave_id, "values": values}))  # Replace with your MQTT topic
